...
#define LED_R_PWM_HANDLE EPWMDEV_PWM1_M1
#define LED_G_PWM_HANDLE EPWMDEV_PWM7_M1
#define LED_B_PWM_HANDLE EPWMDEV_PWM0_M1
...
{
    IoTPwmInit(LED_R_PWM_HANDLE);
    IoTPwmInit(LED_G_PWM_HANDLE);
    IoTPwmInit(LED_B_PWM_HANDLE);
}

void light_set_pwm(unsigned int duty)
{
    IoTPwmStart(LED_R_PWM_HANDLE, duty, 1000);
    IoTPwmStart(LED_G_PWM_HANDLE, duty, 1000);
    IoTPwmStart(LED_B_PWM_HANDLE, duty, 1000);
}
...
void light_set_state(bool state)
{
    ...
    {
        light_set_pwm(1);
        IoTPwmStop(LED_R_PWM_HANDLE);
        IoTPwmStop(LED_G_PWM_HANDLE);
        IoTPwmStop(LED_B_PWM_HANDLE);
    }
...
void lcd_load_ui(void)
{
    ...
    lcd_show_string(101, 156, ": ", LCD_RED, LCD_WHITE, 24, 0);
